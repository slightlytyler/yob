...
```
in:inbox after:2026/05/01 (recruiter OR recruiting OR talent OR "reaching out" OR "open role" OR "open position" OR "job opportunity" OR hiring OR "building out" OR "growing our team" OR "portfolio compan" OR "love to chat" OR "what you're building" OR "what you're looking to do next") -category:promotions
...
**Second confirmed miss, fixed 2026-09-24 (same day, same class):** `eric@natural.com`, a co-founder cold-emailing directly (thread `1a0ab7b061d0ab80`), was missed just as completely — the entire body was *"Your background is incredibly interesting. I'm Eric, one of the co-founders here at Natural. We raised $40M to build the payments infra for agents. I'd love to chat about what you're looking to do next!"* No role, no team-building language, no "talent"/"hiring" framing at all — just a founder opening a conversation. This is a step softer than the human.capital miss above: that one at least mentioned building out a team; this one doesn't pitch anything concrete. Added `"love to chat"` and `"what you're looking to do next"` (plus the near-miss `"what you're building"`) to the keyword list. **Don't expect this to be the last one.** Founder-led cold outreach that doesn't mention a role, a team, or recruiting at all is close to unfilterable by keyword search — the two confirmed misses so far form a spectrum from "soft team-building language" to "no hiring language whatsoever," and there will be a next point further along that spectrum. When it happens, keep generalizing from the specific phrase rather than only adding it verbatim, but also flag to Tyler in the run summary that this is an inherent, recurring limitation of keyword search, not a bug to be fully solved.
